	...
	if button:
		if not(Emotion):
			...
			if Language == "None" and Singer == "None":
			  webbrowser.open(f"https://www.youtube.com/results?search_query={Emotion}+songs")#Always Use Formatted String.
			elif Language == "None":
				webbrowser.open(f"https://www.youtube.com/results?search_query={Singer}+{Emotion}+songs")
			elif Singer == "None":
				webbrowser.open(f"https://www.youtube.com/results?search_query={Language}+{Emotion}+songs")
			else:
				webbrowser.open(f"https://www.youtube.com/results?search_query={Language}+{Singer}+{Emotion}+songs")
except:
